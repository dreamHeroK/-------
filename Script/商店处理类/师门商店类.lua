...
-- @Last Modified time: 2025-09-08 21:20:35
--======================================================================--
-- @作者: GGE研究群: 342119466
-- @创建时间:   2018-03-03 02:34:19
-- @Last Modified time: 2023-02-08 12:19:52
...
function 师门商店类:加载数据()
		-- local 道具店数据= 取csv数据("其他表/道具店.csv")
		-- local 环装店数据= 取csv数据("其他表/环装店.csv")
		-- local 召唤兽店数据= 取csv数据("其他表/召唤兽店.csv")
	...
	--玩家数据[id].召唤兽:添加召唤兽("泡泡","泡泡","宝宝",属性,0,染色方案,技能组,资质组,成长,参战等级,属性表)
		-- self.召唤兽数据={}
	for i=1,#召唤兽店数据 do
		self.召唤兽数据[i]=宝宝类.创建()
