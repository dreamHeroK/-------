...
-- @Last Modified time: 2026-01-19 21:42:25
function 调试信息(...)
...
-- function 取八的倍数(num) ---这里是否可以换成随意数字呢
-- 	if num<8 then
-- 	    return false
-- 	else
-- 		local aa = (num+8)/8
-- 		if qz(aa)==(num+8)/8 then
-- 		    return true
-- 		end
-- 	end
-- 	return false
...
--   if string.find(str, '{') ~= nil or string.match(str, "^%[.-%]$")  then
