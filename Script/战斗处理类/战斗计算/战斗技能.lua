...
-- @Last Modified time: 2026-04-27 17:11:50
...
function 战斗技能:夜舞倾城(战斗数据,编号,目标)
	...
	local 伤害 = 战斗数据.参战单位[编号].力量*1.5+战斗数据.参战单位[编号].速度/3
...
function 战斗技能:乘胜追击(战斗数据,编号,目标)
	if 战斗数据.参战单位[目标]~=nil and  战斗数据.参战单位[编号].乘胜追击~= nil and 战斗数据.参战单位[编号].乘胜追击 >= 4  then
		...
		战斗数据.参战单位[编号].乘胜追击=0   ----------佬伍修改（修复乘胜追击）
...
function 战斗技能:嗜血追击(战斗数据,编号,目标)
	if 战斗数据.参战单位[编号].嗜血追击==1 and 战斗数据.参战单位[编号].嗜血触发==nil and 战斗数据:取目标状态(编号,战斗数据.参战单位[编号].指令.目标,2)==false then
		...
		if 战斗数据.参战单位[编号].苍鸾怒击 and 战斗数据.参战单位[编号].苍鸾怒击==1 and 战斗数据:取目标状态(编号,战斗数据.参战单位[编号].指令.目标,2) then
				战斗数据.参战单位[编号].苍鸾怒击=2
...
function 战斗技能:救死扶伤1(战斗数据,编号,目标)
	local fhz = 0
	fhz = 战斗数据.参战单位[目标].最大气血
	fhz = 战斗数据:治疗量计算(编号,目标,fhz,"救死扶伤1","恢复技能")
	战斗数据:增加气血(目标,fhz,"回魂咒")
	return fhz
end
...
function 战斗技能:雨落寒沙(战斗数据,编号,目标,目标数,执行数)
	...
	local 等级 = 战斗数据:取技能等级(编号,"雨落寒沙")+60 --12.10增强
	...
	if 取随机数()<=30 then
		战斗数据:添加状态("毒", 战斗数据.参战单位[目标],战斗数据.参战单位[目标], 战斗数据:取技能等级(目标,"雨落寒沙"))
		-- 战斗数据.参战单位[目标].法术状态.毒.回合掉血 = 战斗数据:取技能等级(编号,"雨落寒沙") *3
		-- 战斗数据.参战单位[目标].法术状态.毒.回合 = 4
	end

	--女儿村技能加强：雨落寒沙附加似玉生香封印效果，走封印成功率判定，回合数复用似玉生香自身的状态属性（只针对玩家）
	if (战斗数据.参战单位[编号].类型 == "角色" or 战斗数据.参战单位[编号].类型 == "系统角色") and 战斗数据:取封印成功("似玉生香", 等级, 战斗数据.参战单位[编号], 战斗数据.参战单位[目标]) and not 初始技能计算:取是否被封印(战斗数据, 目标) then
		战斗数据:添加状态("似玉生香", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 等级)
	end

	--新增女儿村本命法宝属性
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="沁香花藤" and  战斗数据.参战单位[编号].门派=="女儿村" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
		战斗数据:添加状态("虚弱", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"雨落寒沙"),nil,2)
		战斗数据.参战单位[目标].法术状态["虚弱"].回合 = 2--强制2回合，第一回合没伤害
		end
	end
...
function 战斗技能:超级飞砂走石(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz = 等级*3.5+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])
	local 分灵 = 1.1 - 目标数*0.05
	战斗数据:添加状态("超级摇头摆尾",战斗数据.参战单位[目标],战斗数据.参战单位[编号],等级)
	if 分灵<=0.5 then
		分灵 = 0.5
	end
	return qz(fhz)
...
function 战斗技能:落叶萧萧(战斗数据,编号,目标,目标数,执行数)
	...
	战斗数据.战斗流程[#战斗数据.战斗流程].流程=205
	local fhz = 等级*2.7+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])+20
	...
	if 战斗数据:取经脉(编号, "神木林","焕新") and not 战斗数据.参战单位[编号].法术状态.风灵 and not 战斗数据.参战单位[编号].法术状态.木精 then
    	...
    	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="万鬼木鱼" and  取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级 then
			分灵=1
		end
	end
	return qz(fhz*分灵)
...
function 战斗技能:风卷残云(战斗数据,编号,目标,目标数,执行数) --伤害和落叶萧萧一样，但是会扣完所有风灵
	...
	local fhz = 等级*3+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])+30
	local 分灵 = self:取分灵系数("神木林",目标数,等级)
...
function 战斗技能:荆棘舞(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz = 等级*3.5+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])+30
	local 分灵 = 1
	local 法暴倍率=2
...
function 战斗技能:冰川怒(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz = 等级*3.2+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])
	local 分灵 = 1
	local 法暴倍率=2
...
function 战斗技能:星月之惠(战斗数据,编号,目标)
	local fhz = 0
	fhz = qz(战斗数据:取技能等级(编号,"星月之惠")*3+80)
...
function 战斗技能:三昧真火(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz = 等级*3.3+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])--+20
	local 分灵 = 1
	if 战斗数据:取目标类型(编号) == "玩家" then
		local sj = 取随机数()
		local num = 0
...
function 战斗技能:超级三昧真火(战斗数据,编号,目标,目标数,执行数)
	local 等级 = 战斗数据.参战单位[编号].等级 + 10
	local fhz = 等级*5+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])--+20
	local 分灵 = 1
	if 战斗数据.参战单位[编号].法术状态.魔冥 then
		if 战斗数据:取目标类型(目标) ~= "玩家" then
			分灵 = 分灵 + 0.03*战斗数据.参战单位[编号].法术状态.魔冥.层数
...
function 战斗技能:飞砂走石(战斗数据,编号,目标,目标数,执行数)
	...
	if 战斗数据:取目标类型(编号) == "玩家" then
		...
		-- if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		-- 	if  战斗数据.参战单位[编号].本命法宝.名称=="烈焰杖"  then
		-- 	fhz=fhz*(1+(战斗数据.参战单位[编号].本命法宝.等级/100))--100
		-- 	end
		...
		--修改为真正的波动伤害
			if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
			    if 战斗数据.参战单位[编号].本命法宝.名称=="烈焰杖"  then
			        local 波动下限 = 1
			        local 波动上限 = 1 + (战斗数据.参战单位[编号].本命法宝.等级 / 100)
			        -- 每个单位结算时都生成新随机数 → 5个单位伤害不同
			        local 随机系数 = 波动下限 + math.random() * (波动上限 - 波动下限)
			        fhz = fhz * 随机系数
			    end
		---------------------------------------------------------------------------------------------
...
function 战斗技能:风云变色(战斗数据,编号,目标,目标数,执行数)
	...
	if 战斗数据:取目标类型(编号) == "玩家" then
		...
		if 战斗数据.参战单位[编号].神焰 + num <=sj then
			local zhi = 0.4
			if 战斗数据:取经脉(编号, "魔王寨","威吓") and 战斗数据:取目标类型(目标) == "召唤兽" and 战斗数据:取指定法宝(编号,"五火神焰印") and 战斗数据.参战单位[编号].神焰-qz(战斗数据:取指定法宝境界(编号,"五火神焰印")/3) <= sj-2 then
				zhi = zhi + 0.42
			end
			if 战斗数据:取经脉(编号, "魔王寨","焰威") and 战斗数据.参战单位[编号].焰威==nil then
				战斗数据.参战单位[编号].焰威=1
...
function 战斗技能:秘传三昧真火(战斗数据,编号,目标,目标数,执行数)
	...
	local 分灵 = 1
	local y =战斗数据.回合数
	local 秒人概率=math.floor((战斗数据.参战单位[目标].气血/战斗数据.参战单位[目标].最大气血)*300)
...
function 战斗技能:秘传飞砂走石(战斗数据,编号,目标,目标数,执行数)
	...
	local 分灵 = self:取分灵系数("魔王寨",目标数,等级)
	local y =战斗数据.回合数
	local 秒人概率=math.floor((战斗数据.参战单位[目标].气血/战斗数据.参战单位[目标].最大气血)*200)
    if 战斗数据:取经脉(编号, "魔王寨", "旋阳") then
	秒人概率=秒人概率*1.03
	end
...
function 战斗技能:魔焰滔天(战斗数据,编号,目标,目标数,执行数)
	...
	if 战斗数据.参战单位[编号].法术状态.魔冥 then --魔王寨也太吊了吧
		local num = 0.03
...
function 战斗技能:推拿(战斗数据,编号,目标,系数)
	...
	if 战斗数据.参战单位[编号].shenqi.name=="风起云墨" and 目标==zhiling.目标 then
...
-- end
	...
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		local 加成几率 = 0
		if 战斗数据.参战单位[编号].类型 == "角色" or 战斗数据.参战单位[编号].类型 == "系统角色" then
			加成几率 = 20 --人物加大触发概率
		end
		if  战斗数据.参战单位[编号].本命法宝.名称=="弥音禅钟" and  战斗数据.参战单位[编号].门派=="化生寺" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级 + 加成几率 then
		战斗数据:添加状态("金刚护法", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"推气过宫"),nil,2)
		end
	end
	...
	local 活血奖励 = 0
	if 战斗技能.活血 and (战斗数据.参战单位[编号].类型 == "角色" or 战斗数据.参战单位[编号].类型 == "系统角色") then
		活血奖励 = 战斗技能:活血(战斗数据,编号,目标,系数) --人物额外触发一次活血治疗
	end
	return zll + 活血奖励
end
...
function 战斗技能:唧唧歪歪(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz = 等级*1.7+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])
...
--================================================五庄观==========================================================
-- function 战斗技能:同伤式(战斗数据,编号,目标,目标数,执行数)
-- 	local 速度差 = math.abs(战斗数据.参战单位[编号].速度 - 战斗数据.参战单位[目标].速度)
-- 	if 速度差 < 1 then 速度差 = 0 end
-- 	local zt = 战斗数据:解除状态结果(战斗数据.参战单位[编号], 初始技能计算:取增益状态法术())
-- 	local ztsl = #zt
-- 	local 伤害 = 速度差 * 4 + 战斗数据.参战单位[编号].等级*2 + #zt*100
-- 	return qz(伤害)
-- end
...
function 战斗技能:兴风作浪(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz = 等级*2+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])
...
function 战斗技能:棍打诸神(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz = 等级*2.4+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])+20
	local 分灵 = 1
	if 战斗数据:取经脉(编号, "花果山", "得意") and 战斗数据.参战单位[编号].法术状态.得意~=nil then
		fhz=fhz*1.16
		战斗数据:取消状态("得意",战斗数据.参战单位[编号])
...
function 战斗技能:龙腾(战斗数据,编号,目标,目标数,执行数)
	...
	local fhz  = 等级*2.9+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])+29+20
	local 分灵 = 1
...
function 战斗技能:亢龙归海(战斗数据,编号,目标,目标数,执行数)
	local 等级 = 69
	local fhz = 等级*2.5+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])+29+20
	local 分灵 = 0.95
...
function 战斗技能:雷霆万钧(战斗数据,编号,目标,目标数,执行数)
	...
	local 分灵 = self:取分灵系数("龙宫",目标数,等级)
	-- 关键修改：万钧触发额外目标时，强制按秒3分灵算
		if 目标数 > 3 then
		    分灵 = self:取分灵系数("龙宫", 3, 等级)
		end
	----------------------------------------------------------
	伤害 = 伤害 * 分灵
	...
	-- if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
	-- 	if  战斗数据.参战单位[编号].本命法宝.名称=="灵明仙桃" and  战斗数据.参战单位[编号].门派=="天宫" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
	-- 	伤害 = 伤害 * (1+(战斗数据.参战单位[编号].本命法宝.等级/100))
	-- 	end
	-- end
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
	    if 战斗数据.参战单位[编号].本命法宝.名称=="灵明仙桃" and  战斗数据.参战单位[编号].门派=="天宫" then
	        伤害 = 伤害 * (1+(战斗数据.参战单位[编号].本命法宝.等级/100))
	    end
	end
...
function 战斗技能:风雷韵动(战斗数据,编号,目标,目标数,执行数)
	...
	local 伤害 = 等级*4+战斗数据:取灵力伤害(战斗数据.参战单位[编号],战斗数据.参战单位[目标])
	local 分灵 = 1.1
	伤害 = 伤害 * 分灵
	if 战斗数据.参战单位[目标].法术状态.电芒 then
		伤害 = 伤害 * 1.08
...
function 战斗技能:雷霆汹涌(战斗数据,编号,目标,目标数,执行数)
	  if not 战斗数据.参战单位[编号].招式特效.雷霆汹涌 then
		战斗数据.战斗流程[#战斗数据.战斗流程].流程=205
	end
...
--新增无底洞本命法宝属性
	-- if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
	-- 	if  战斗数据.参战单位[编号].本命法宝.名称=="炼妖壶" and  战斗数据.参战单位[编号].门派=="无底洞" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
	-- 	战斗数据:添加状态("明光宝烛", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"地涌金莲"),nil,2)
	-- 	战斗数据.参战单位[目标].法术状态["明光宝烛"].回合 = 2
	-- 	end
	-- end
...
function 战斗技能:夺命咒(战斗数据,编号,目标,目标数,执行数)
	local 等级 = 战斗数据:取技能等级(编号,"夺命咒")+战斗数据.参战单位[编号].固定伤害+50
	...
	if 战斗数据:取经脉(编号, "无底洞", "夺血") then--"#Y
		伤害=伤害+战斗数据.回合数*4
	end
	if 战斗数据:取经脉(编号, "无底洞", "冥煞") and math.random(100)<=5 then--"#Y
		伤害=伤害*2
	end
...
function 战斗技能:紧箍咒(战斗数据,编号,目标)
	local sh = 战斗数据:取技能等级(编号,"紧箍咒")+100
	...
	if 战斗数据.参战单位[编号].法术状态.莲心剑意 then
		sh = sh * (1+战斗数据.参战单位[编号].法术修炼 *0.03)
	end
	return qz(sh)
end
...
-- local 修炼等级 = 25
-- local 暗器等级 = 160
-- local 修炼 = 1+修炼等级*0.02
-- local 暗器 = 暗器等级*暗器等级/150 + 暗器等级
-- local 目标数=2
-- local 分灵 = 1-目标数*0.1
-- if 分灵<=0.6 then
-- 	分灵=0.6
...
-- local 阵法=1
-- local 装备伤害 = 650
-- local 伤害 = (等级+暗器+固伤+敏捷)*分灵*阵法*修炼--+修炼等级*5


-- local 莲心剑意 = 1+修炼等级*0.03
	...
	--新增普陀山本命法宝属性
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="琼华玉露" and  战斗数据.参战单位[编号].门派=="普陀山" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
			战斗数据:添加状态("紧箍咒", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"靛沧海"),nil,2)
		            战斗数据.参战单位[目标].法术状态["紧箍咒"].回合 = 2
		end
	            end
...
function 战斗技能:日光华(战斗数据,编号,目标,目标数,执行数)
	...
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="琼华玉露" and  战斗数据.参战单位[编号].门派=="普陀山" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
			战斗数据:添加状态("紧箍咒", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"日光华"),nil,2)
		            战斗数据.参战单位[目标].法术状态["紧箍咒"].回合 = 2
		end
	            end
...
function 战斗技能:地裂火(战斗数据,编号,目标,目标数,执行数)
	...
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="琼华玉露" and  战斗数据.参战单位[编号].门派=="普陀山" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
			战斗数据:添加状态("紧箍咒", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"地裂火"),nil,2)
		            战斗数据.参战单位[目标].法术状态["紧箍咒"].回合 = 2
		end
	            end
...
function 战斗技能:苍茫树(战斗数据,编号,目标,目标数,执行数)
	...
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="琼华玉露" and  战斗数据.参战单位[编号].门派=="普陀山" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
			战斗数据:添加状态("紧箍咒", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"苍茫树"),nil,2)
		            战斗数据.参战单位[目标].法术状态["紧箍咒"].回合 = 2
		end
	            end
...
function 战斗技能:巨岩破(战斗数据,编号,目标,目标数,执行数)
	...
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="琼华玉露" and  战斗数据.参战单位[编号].门派=="普陀山" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
			战斗数据:添加状态("紧箍咒", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"巨岩破"),nil,2)
		            战斗数据.参战单位[目标].法术状态["紧箍咒"].回合 = 2
		end
	            end
...
function 战斗技能:阎罗令(战斗数据,编号,目标,目标数,执行数)
	...
	-- if not 战斗数据.PK战斗 then
	-- 	fhz = fhz +qz(战斗数据.参战单位[编号].装备伤害/2)
	-- 	fhz = fhz + (qz(战斗数据.参战单位[编号].敏捷*0.35))
	-- end
...
-- local 伤害 = (等级+暗器+固伤+敏捷)*分灵*阵法*修炼+修炼等级*5
	...
	local 等级 = 战斗数据:取技能等级(编号,"阎罗令")*3+30
	local 敏捷 = (战斗数据.参战单位[编号].敏捷 + 战斗数据.参战单位[编号].装备敏捷)*0.4--0.35
	local 暗器 = 0
	local 分灵 = 1-目标数*0.1
	if 分灵<=0.6 then
		分灵=0.6
...
--新增地府本命法宝属性
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="祭魄印" and  战斗数据.参战单位[编号].门派=="阴曹地府" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
		战斗数据:添加状态("尸腐毒", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"阎罗令"),nil,2)
		战斗数据.参战单位[目标].法术状态["尸腐毒"].回合 = 2--强制2回合，第一回合没伤害
		end
	end
...
-- 465
-- 打蓝205
	local 等级 = 战斗数据:取技能等级(编号,"判官令")*5+30
	local 敏捷 = (战斗数据.参战单位[编号].敏捷 + 战斗数据.参战单位[编号].装备敏捷)*0.4--0.35
	local 暗器 = 0
	local 阵法 = 1
	local 修炼 = 战斗数据.参战单位[编号].法术修炼-战斗数据.参战单位[目标].抗法修炼
...
function 战斗技能:天罗地网(战斗数据,编号,目标,目标数,执行数)
	-- local 等级 = 战斗数据:取技能等级(编号,"天罗地网")
	-- local fhz =等级*3
	-- if not 战斗数据.PK战斗 then
	-- 	fhz = fhz + qz(战斗数据.参战单位[编号].伤害*0.166)
	-- end
	-- if 执行数==1 then
	--     fhz = fhz + qz(战斗数据.参战单位[编号].装备伤害/2)
	-- end
	local 等级 = 战斗数据:取技能等级(编号,"天罗地网")*2+50
	local 暗器 = 0
	local 阵法 = 1
	local 修炼差 = 战斗数据.参战单位[编号].法术修炼-战斗数据.参战单位[目标].抗法修炼
	if 战斗数据.参战单位[编号].固伤加成 ~= nil then --这个是阵法
	...
	if 战斗数据:取经脉(编号,"盘丝洞","扑袭") and 战斗数据:取门派是否唯一(编号,"盘丝洞") and 参战单位[目标].法术状态.天罗地网==nil then
		伤害 = 伤害 * 1.4
	end
	-- if not 战斗数据.参战单位[目标].法术状态.天罗地网 and 取随机数()<=20 then
...
--新增盘丝洞本命法宝属性
	if not 战斗数据.PK战斗 and 战斗数据.参战单位[编号].本命法宝 and 战斗数据.参战单位[编号].本命法宝.开启 and 战斗数据.参战单位[编号].本命法宝.耐久>0 then
		if  战斗数据.参战单位[编号].本命法宝.名称=="迷情镜" and  战斗数据.参战单位[编号].门派=="盘丝洞" and 取随机数(1,100) <= 战斗数据.参战单位[编号].本命法宝.等级  then
			战斗数据:添加状态("瘴气", 战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 战斗数据:取技能等级(编号,"天罗地网"),nil,2)
		            战斗数据.参战单位[目标].法术状态["瘴气"].回合 = 2
		end
	            end
	...
	if 战斗数据.参战单位[编号].jianshe and 战斗数据.参战单位[编号].无心插柳 == false then
		...
		if 战斗数据.参战单位[编号].指令.附加 == "友伤" then
			...
			if 战斗数据:取经脉(编号, "大唐官府","风刃") then
				...
				风刃伤害 = 战斗数据.参战单位[编号].等级 * 3 + 风魂伤害
			end
		end
		for i=1,#溅射目标 do
			if 溅射目标[i] ~= 目标 and 目标数~=0 and 战斗数据.战斗流程[#战斗数据.战斗流程].挨打方 and 战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[1] and 战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[1].伤害 then
				if 战斗数据.参战单位[编号].指令.附加 == "友伤" then
					战斗计算:添加掉血(战斗数据,溅射目标[i],溅射伤害+风刃伤害,编号)
				else
					战斗计算:添加掉血(战斗数据,溅射目标[i],qz(战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[1].伤害*战斗数据.参战单位[编号].jianshe+风刃伤害),编号)
				end
			end
		end
	end
...
function 战斗技能:嗜血幡(战斗数据,编号,目标)
	...
	if 战斗数据:取指定法宝(编号,"嗜血幡") and 战斗数据:取行动状态(编号) and 战斗数据:取目标状态(编号,zhiling.目标,1) then --
	...
	if 战斗数据:取指定法宝(编号,"嗜血幡","重复") and 战斗数据:取行动状态(编号) and 战斗数据:取目标状态(编号,zhiling.目标,1) then --
		-- 目标 = 战斗数据:取单个敌方目标(编号)
		-- if 目标~=0 then
		-- 	战斗数据.参战单位[编号].指令.目标=目标
  -- 			战斗数据:普通攻击计算(编号,0.5)
		-- end
		目标 = 战斗数据:取如意神通目标(编号,zhiling.目标)
		if 目标~=0 then
			zhiling.目标=目标
			if #战斗数据.参战单位[编号].追加法术>0 and 取随机数()<=战斗数据.参战单位[编号].套装追加概率 then
				战斗数据.参战单位[编号].嗜血幡 = true
...
-- 	if 战斗数据.参战单位[编号].嗜血幡==nil and #战斗数据.参战单位[编号].追加法术>0 and 取随机数()<=战斗数据.参战单位[编号].套装追加概率 and 战斗数据:取法术状态(编号) then
-- 		战斗数据.参战单位[编号].指令.类型="法术"
-- 		战斗数据.参战单位[编号].指令.参数=战斗数据.参战单位[编号].追加法术[1].名称
-- 		战斗数据:法术计算(编号,1)
-- 	end
...
function 战斗技能:追加法术(战斗数据, 编号, 目标)
	if 调试模式 then
		战斗数据.参战单位[编号].套装追加概率 = 100
	end
	-- ==============================================
	-- 【修复】宝宝死了，直接停止追加法术
	local 单位 = 战斗数据.参战单位[编号]
	if 单位 == nil or 单位.气血 <= 0 then
	    return
	end
	-- ==============================================
	...
	if 战斗数据.参战单位[编号].嗜血幡 == nil and #战斗数据.参战单位[编号].追加法术 > 0 and 取随机数() <= 战斗数据.参战单位[编号].套装追加概率 and 战斗数据:取法术状态(编号) then
		...
		zhiling.类型="法术"
		zhiling.参数 = 战斗数据.参战单位[编号].追加法术[取随机数(1, #战斗数据.参战单位[编号].追加法术)].名称

		if 目标 then
			zhiling.目标 = 目标
		end

		if 战斗数据.参战单位[编号].玩家id ~= 0 then
			-- Nothing
		end
...
function 战斗技能:披坚执锐(战斗数据, 编号, 目标, 披挂上阵)
	local fj = 5
	local gl = 战斗数据.参战单位[编号].套装追加概率

	if 战斗数据.参战单位[编号].潜心 ~= nil then
		fj = fj + 100
	end
	...
	if 取随机数() < gl then
		...
		战斗数据.战斗流程[#战斗数据.战斗流程].幸运一击 = 战斗数据.参战单位[编号].指令.参数
...
function 战斗技能:惊天动地一(编号,名称,等级,战斗数据)
	-- if 攻击方.气血 >= 攻击方.最大气血 * 0.9 then--and 战斗数据:取友方阵亡人数(攻击方.序号)>=2 then --条件加在这 =6
	-- 	return true
	-- end
	if 战斗数据.参战单位[编号].惊天动地使用 == nil then
		战斗数据.参战单位[编号].惊天动地使用 = true
	else
		return true
	end
...
function 战斗技能:惊天动地二(编号,名称,目标,执行数,战斗数据)
	...
	战斗数据.执行等待=战斗数据.执行等待+5
	local  伤害=qz(战斗数据:取基础物理伤害(编号,目标)*2.5 + 1000)
	local  最终伤害=战斗数据:取最终物理伤害(编号,目标,伤害*0.1,5,2)
...
--================================================灵宝==========================================================
function 战斗技能:噬魔神壶(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	local 当前流程=#战斗数据.战斗流程
	战斗数据.战斗流程[当前流程].跳转流程=1030
	战斗数据.战斗流程[当前流程].挨打方[执行数]={特效={名称},挨打方={}}
	-- local 随机单位=取随机数(1,3)
	-- if 取随机数()<=60 and 随机单位==3 then
 --       随机单位=取随机数(1,2)
	-- end
	local 随机单位
	local 倍数 = 1
	...
	local 目标=战斗数据:取多个敌方目标(编号,目标,随机单位)
	for i=1,#目标 do
		local 当前目标 = 目标[i]
		战斗数据.战斗流程[当前流程].挨打方[i] = {}
		战斗数据.战斗流程[当前流程].挨打方[i].挨打方 = 当前目标
		战斗数据.战斗流程[当前流程].挨打方[i].次数={}
		local 基数=0
		local 动作
		for n=1,6 do
		local 伤害 = math.floor(战斗数据:取基础物理伤害(编号,当前目标,名称) *倍数)
	        local 最终伤害=战斗数据:取最终物理伤害(编号,当前目标,伤害,0,0.1,名称)
		    最终伤害.伤害=qz(最终伤害.伤害)
		    if 最终伤害.伤害<1 or 战斗数据.参战单位[当前目标].物理免疫 then
		        最终伤害.伤害=1
		    end
		    战斗数据.战斗流程[当前流程].挨打方[i].次数[n]=最终伤害.伤害
		    基数=基数+最终伤害.伤害
		    动作=最终伤害.动作
		end
        local 结果 = 战斗数据:取伤害结果(编号,当前目标,基数,false,nil,0.1,名称,防御)
	    结果.伤害=qz(结果.伤害)
	    if 结果.伤害<1 or 战斗数据.参战单位[当前目标].物理免疫 then
	        结果.伤害=1
	    end
        战斗数据.战斗流程[当前流程].挨打方[i].死亡=战斗数据:减少气血(当前目标,结果.伤害,编号,名称)
	    战斗数据.战斗流程[当前流程].挨打方[i].动作=动作
	    战斗数据.战斗流程[当前流程].挨打方[i].伤害=结果.伤害
	    战斗数据.战斗流程[当前流程].挨打方[i].伤害类型=结果.类型
	end
	战斗数据.战斗流程[当前流程].返回=战斗数据.参战单位[编号].允许返回
    for k,v in pairs(战斗数据.参战单位) do
    end
end
function 战斗技能:断穹巨剑(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={特效={名称},挨打方=目标}
	local 伤害 = 战斗数据.参战单位[编号].伤害--战斗数据:取基础物理伤害(编号,目标)
	-- local  最终伤害=战斗数据:取最终物理伤害(编号,目标,伤害)
	local  最终伤害=战斗数据:取最终物理伤害(编号,目标,伤害,10,10)
	local  伤害值=战斗数据:取伤害结果(编号,目标,最终伤害.伤害,最终伤害.暴击,nil,1)
	local 倍数 = 1
	if 消耗 == 1 then
		倍数=1.5
...
function 战斗技能:相思寒针(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	...
	倍数=倍数
	战斗数据.参战单位[目标].法术状态.相思寒针.境界=50 * (境界 / 5)
...
function 战斗技能:风舞心经(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	...
	倍数=倍数+境界
	if 战斗数据:取经脉(目标, "神木林","灵归") then
		战斗数据.参战单位[目标].法术状态.风灵.层数 = qz(战斗数据.参战单位[目标].法术状态.风灵.层数 + 倍数)
	end
end
...
function 战斗技能:青狮獠牙(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	...
	if 战斗数据.参战单位[战斗数据.参战单位[目标].召唤兽] then
		战斗数据.参战单位[战斗数据.参战单位[目标].召唤兽].最大气血 = qz(战斗数据.参战单位[战斗数据.参战单位[目标].召唤兽].最大气血 * 倍数)
		战斗数据.参战单位[战斗数据.参战单位[目标].召唤兽].气血 = math.min(战斗数据.参战单位[战斗数据.参战单位[目标].召唤兽].气血, 战斗数据.参战单位[战斗数据.参战单位[目标].召唤兽].最大气血)
	end
end
...
function 战斗技能:缚仙蛛丝(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	...
	local 随机数 = {3,5,20}
	local 随机限制 = 随机数[取随机数(1,3)]
	战斗数据.参战单位[目标].法术状态.缚仙蛛丝.境界=随机限制
...
function 战斗技能:煞魂冥灯(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	...
	if 战斗数据.参战单位[目标].气血上限 then
		...
		战斗数据.参战单位[目标].最大气血 = math.min(战斗数据.参战单位[目标].最大气血, 战斗数据.参战单位[目标].气血上限)
	else
		战斗数据.参战单位[目标].最大气血 = 战斗数据.参战单位[目标].最大气血*战斗数据.参战单位[目标].法术状态.煞魂冥灯.境界
	end
	战斗数据.参战单位[目标].气血 = math.min(战斗数据.参战单位[目标].气血, 战斗数据.参战单位[目标].最大气血)
end
...
function 战斗技能:寒霜盾戟(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	...
	--倍数=倍数+境界
	if not 战斗数据.参战单位[目标].法术状态.寒霜盾戟.层数 then
		战斗数据.参战单位[目标].法术状态.寒霜盾戟.层数 = 1
	else
		战斗数据.参战单位[目标].法术状态.寒霜盾戟.层数 = 战斗数据.参战单位[目标].法术状态.寒霜盾戟.层数 + 1
	end
...
function 战斗技能:乾坤木卷(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	local 倍数 = 1
	if 消耗 == 1 then
		倍数=0.025
...
function 战斗技能:乾坤水卷(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	local 倍数 = 1
	if 消耗 == 1 then
		倍数=0.025
...
function 战斗技能:乾坤火卷(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	local 倍数 = 1
	if 消耗 == 1 then
		倍数=0.025
...
function 战斗技能:乾坤土卷(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	local 倍数 = 1
	if 消耗 == 1 then
		倍数=0.025
...
function 战斗技能:赤炎战笛(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	战斗数据:添加状态(名称,战斗数据.参战单位[目标], 战斗数据.参战单位[编号], 等级)
	if 战斗数据.参战单位[目标].法术状态.超级赐福·五福 or 战斗数据.参战单位[目标].法术状态.超级赐福·七神
	or 战斗数据.参战单位[目标].法术状态.超级赐福·四季 or 战斗数据.参战单位[目标].法术状态.超级赐福·三和
	or 战斗数据.参战单位[目标].法术状态.超级赐福·双喜 or 战斗数据.参战单位[目标].法术状态.超级赐福·元吉
	or 战斗数据.参战单位[目标].法术状态.超级赐福·万利 or 战斗数据.参战单位[目标].法术状态.超级赐福·十满
	or 战斗数据.参战单位[目标].法术状态.超级赐福·九功 or 战斗数据.参战单位[目标].法术状态.超级赐福·八欲
	or 战斗数据.参战单位[目标].法术状态.超级赐福·六临 then
	return
	end

	if 战斗数据.参战单位[目标].法术状态.赤炎战笛.叠加层数 == nil then
	    战斗数据.参战单位[目标].法术状态.赤炎战笛.叠加层数 = 1
	else
	    战斗数据.参战单位[目标].法术状态.赤炎战笛.叠加层数 = 战斗数据.参战单位[目标].法术状态.赤炎战笛.叠加层数 + 1
	end
	if 战斗数据.参战单位[目标].法术状态.赤炎战笛.叠加层数 >= 2 then
		战斗数据.参战单位[目标].法术状态.赤炎战笛.叠加层数 = 2
	end
	战斗数据.参战单位[目标].法术状态.赤炎战笛.伤害 = 1.5 * (境界 / 5) * 战斗数据.参战单位[目标].法术状态.赤炎战笛.叠加层数
	战斗数据.参战单位[目标].法术状态.赤炎战笛.回合 = 1
end

function 战斗技能:护体灵盾(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	战斗计算:添加护盾(战斗数据,目标,战斗数据.参战单位[目标].等级*12*(1+境界/20),"护体灵盾")
end
...
function 战斗技能:惊兽云尺(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	战斗数据:添加状态(名称, 战斗数据.参战单位[目标], 战斗数据.参战单位[编号],等级)
	if 战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数 == nil then
	    战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数 = 1
	else
	    战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数 = 战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数 + 1
	end
	战斗数据.参战单位[目标].法术状态.惊兽云尺.降低伤害 = (境界 / 5) * 0.4 * 战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数
	战斗数据.参战单位[目标].法术状态.惊兽云尺.增加伤害 = (境界 / 5) * 0.3 * 战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数
	战斗数据.参战单位[目标].法术状态.惊兽云尺.回合=999
	战斗数据.参战单位[目标].防御 = qz(战斗数据.参战单位[目标].防御 * (1 - (境界 / 5) * 0.1 * 战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数))
	战斗数据.参战单位[目标].法防 = qz(战斗数据.参战单位[目标].法防 * (1 - (境界 / 5) * 0.1 * 战斗数据.参战单位[目标].法术状态.惊兽云尺.叠加层数))
end
...
function 战斗技能:锢魂命谱(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	...
	if 战斗数据.参战单位[目标].法术状态.锢魂术 then
		战斗数据.参战单位[目标].法术状态.锢魂术.回合 = qz(战斗数据.参战单位[目标].法术状态.锢魂术.回合 + 倍数)
	end
end

function 战斗技能:战神宝典(战斗数据,名称,编号,目标,消耗,执行数,目标数,境界,等级)
	战斗数据.战斗流程[#战斗数据.战斗流程].挨打方[执行数]={挨打方 = 目标, 特效 = {名称}}
	if 战斗数据.参战单位[编号].战神宝典 then return end
	战斗数据:添加状态(名称, 战斗数据.参战单位[目标], 战斗数据.参战单位[编号],等级)
	local 倍数 = 1
	if 消耗 == 1 then
		倍数 = 0.0025
	...
	战斗数据.参战单位[目标].法术状态.战神宝典.消耗=消耗
	战斗数据.参战单位[目标].法术状态.战神宝典.回合=999
	战斗数据.参战单位[编号].战神宝典 = true
end
