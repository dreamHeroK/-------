...
-- @Last Modified time: 2026-06-06 15:00:40
...
function 战斗执行类:回合开始计算(战斗数据,编号) --这里+的属性估计不同步
	...
	if 战斗数据.参战单位[编号].法术状态 and 战斗数据.参战单位[编号].法术状态.战神宝典 then
		if 战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 == nil then
		  战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 = 1
		else
		  战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 = 战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 + 1
		end
		if 战斗数据.参战单位[编号].法术状态.战神宝典.消耗 == 6 and 战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 >= 6 then
			战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 = 6
		elseif 战斗数据.参战单位[编号].法术状态.战神宝典.消耗 == 7 and 战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 >= 3 then
			战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 = 3
		elseif 战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 >= 9 then
			战斗数据.参战单位[编号].法术状态.战神宝典.执行回合 = 9
		end
	end
	if not 战斗数据:取经脉(编号, "方寸山","咒诀") and 战斗数据.参战单位[编号].JM and 战斗数据.参战单位[编号].JM.当前流派=="五雷正宗" and  战斗数据.参战单位[编号].法术状态.符咒 then
    战斗数据.参战单位[编号].法术状态.符咒.层数=math.random(1,5)
  end
  if 战斗数据.参战单位[编号].JM and 战斗数据.参战单位[编号].JM.当前流派=="五雷正宗" and 战斗数据:取经脉(编号, "方寸山","咒诀") and  战斗数据.参战单位[编号].法术状态.符咒 and 战斗数据.参战单位[编号].法术状态.雷法·坤伏.层数+战斗数据.参战单位[编号].法术状态.雷法·崩裂.层数+战斗数据.参战单位[编号].法术状态.雷法·轰天.层数+ 战斗数据.参战单位[编号].法术状态.雷法·震煞.层数>0  then
    战斗数据.参战单位[编号].法术状态.符咒.层数=math.random(1,5)
  end
  if 战斗数据.参战单位[编号].JM and 战斗数据.参战单位[编号].JM.当前流派=="五雷正宗" and 战斗数据:取经脉(编号, "方寸山","咒诀") and  战斗数据.参战单位[编号].法术状态.符咒 and 战斗数据.参战单位[编号].法术状态.雷法·坤伏.层数+战斗数据.参战单位[编号].法术状态.雷法·崩裂.层数+战斗数据.参战单位[编号].法术状态.雷法·轰天.层数+ 战斗数据.参战单位[编号].法术状态.雷法·震煞.层数==0  then
	...
	if 战斗数据.参战单位[编号].门派=="天宫" then
		...
		if 战斗数据.参战单位[编号].法术状态 and 战斗数据.参战单位[编号].法术状态.威仪九霄 and 战斗数据.参战单位[编号].法术状态.威仪九霄.层数<30 then
...
function 战斗执行类:执行计算(战斗数据) --回合开始
	...
	for n=1,#战斗数据.参战单位 do
		if type(战斗数据.参战单位[n].主动技能) == "table" then
	...
	for n=1,#战斗数据.参战单位 do
		if 战斗数据.参战单位[n].法术状态 and 战斗数据.参战单位[n].法术状态.波澜不惊 then
			战斗数据.参战单位[n].法术状态.波澜不惊.次数=0
		end
		if 战斗数据:取目标状态(n,n,2)  then
			if 战斗数据.参战单位[n].法术状态 == nil then
				print("法术状态不存在",战斗数据.参战单位[n].名称,战斗数据.参战单位[n].JM)
			end
			...
			elseif 战斗数据.参战单位[n].法术状态.普渡众生  then
				...
				if 战斗数据.参战单位[n].法术状态.普渡众生.首回合 then
					...
					战斗数据:持续回血处理(bh, 战斗数据.参战单位[n], dj*4+20, "普渡众生")
				else
					战斗数据:持续回血处理(bh, 战斗数据.参战单位[n], dj*3.2+20, "普渡众生")
				end
			elseif 战斗数据.参战单位[n].法术状态.冥火炼炉 then
				local 编号 = 战斗数据.参战单位[n].法术状态.冥火炼炉.攻击编号
				local 气血 = qz(战斗数据.参战单位[n].法术状态.冥火炼炉.境界)
			...
			elseif 战斗数据.参战单位[n].法术状态.摇头摆尾  then
				...
				战斗计算:不击退掉血(战斗数据,n,气血,编号)
			elseif 战斗数据.参战单位[n].法术状态.超级摇头摆尾  then
				local 编号=战斗数据.参战单位[n].法术状态.超级摇头摆尾.攻击编号
				local 气血=战斗数据.参战单位[n].法术状态.超级摇头摆尾.等级+800
				战斗计算:不击退掉血(战斗数据,n,气血,编号)
			...
			elseif 战斗数据.参战单位[n].法术状态.毒  then
				...
				if 气血>=战斗数据.参战单位[n].等级*10 then
					气血 = 战斗数据.参战单位[n].等级*10
				end
				if 战斗数据.参战单位[n].法术状态.毒.回合掉血 == nil then --其他的毒
					local 魔法=qz(战斗数据.参战单位[n].魔法*0.05)
					-- if 战斗数据:取符石技能(n,"柳暗花明") then
					-- 	气血=  气血*(1-战斗数据.参战单位[n].符石技能["柳暗花明"])
					-- 	魔法 = 魔法*(1-战斗数据.参战单位[n].符石技能["柳暗花明"])
					-- end
...
function 战斗执行类:执行计算1(战斗数据)
  --检查一遍后发制人
  	if 战斗数据.执行对象 == nil then
  		print("tbcopy1")
  	end
  	local 执行组 = table.copy(战斗数据.执行对象)
  	local 执行组总数 = #执行组
    ...
    for xx=1,1 do
    	for n=1,执行组总数 do
	        ...
	        if 执行组[n] and 战斗数据.全局结束==nil and 战斗数据.参战单位[战斗数据.执行对象[n]].气血 > 0 and 战斗数据:取行动状态(战斗数据.执行对象[n]) and not 战斗数据:死亡处理() then

	       -- if 执行组[n] and 战斗数据.全局结束==nil and 战斗数据:取行动状态(战斗数据.执行对象[n]) and not 战斗数据:死亡处理() then --取行动状态 要改改 有些是可以防御，保护，召唤啥的
	            执行组[n] = nil
	            local 编号=战斗数据.执行对象[n]
	         ...
	         --          if 战斗数据.战斗类型 >=120010 and 战斗数据.战斗类型 <= 120045 and 战斗数据.参战单位[编号].AI战斗 == nil  then
										-- 	天罡星AI:智能战斗(战斗数据,编号,"战斗指令")
										-- end
	                end
	            else
	                战斗数据.参战单位[编号].指令.类型=""
	            ...
	            --if 战斗数据.参战单位[战斗数据.执行对象[n]].奇袭指令~=nil and 战斗数据.参战单位[战斗数据.执行对象[n]].奇袭指令.类型~=nil then
--修复奇袭法术触发判断
			if 战斗数据.参战单位[战斗数据.执行对象[n]].奇袭指令~=nil
			and 战斗数据.参战单位[战斗数据.执行对象[n]].奇袭指令.类型~=nil
			and 战斗数据.参战单位[战斗数据.执行对象[n]].奇袭法术 == true then

				self.原指令 = table.copy(战斗数据.参战单位[编号].指令)
				-- print("========5675475474",n,战斗数据.参战单位[战斗数据.执行对象[n]].名称)
				self:奇袭指令执行(战斗数据, n, 战斗数据.参战单位[战斗数据.执行对象[n]].奇袭指令)
				战斗数据.参战单位[战斗数据.执行对象[n]].奇袭指令 = nil
			end
			if self.原指令 then
				战斗数据.参战单位[编号].指令 = table.copy(self.原指令)
				self.原指令 = nil
			end

	            -- 调试信息(编号.."指令类型为"..战斗数据.参战单位[编号].指令.类型)
	            -- 调试信息(编号.."指令状态为"..战斗数据.参战单位[编号].名称)
	            -- 调试信息(编号.."指令目标为"..战斗数据.参战单位[编号].指令.目标)
				...
				if 战斗数据.参战单位[编号].魔法 < 40 then
	                ...
	                elseif 战斗数据.参战单位[编号].指令.类型=="法术" then--法术攻击
	                    ...
	                    if 装备特技[战斗数据.参战单位[编号].指令.参数]~=nil then
	                        if 战斗数据:取特技状态(战斗数据.执行对象[n]) and (战斗数据.参战单位[编号].队伍==0 or 初始技能计算:取技能CD(战斗数据,战斗数据.参战单位[编号],战斗数据.参战单位[编号].指令.参数)) then
	                            战斗数据:法术计算(编号,1)
	                    ...
	                    elseif skill法宝技能[战斗数据.参战单位[编号].指令.参数]~=nil then
	                        ...
	                        if 战斗数据:取法术状态(战斗数据.执行对象[n]) then
	                            if 战斗数据.参战单位[编号].队伍~=0 and not 初始技能计算:取技能CD(战斗数据,战斗数据.参战单位[编号],战斗数据.参战单位[编号].指令.参数) then
	                                ...
	                                self:自动释放技能(战斗数据, 战斗数据.参战单位[编号],编号)-- 新增战斗数据参数
	                                ----------------------------------
 -- 需要增益启用这个                            	if 战斗数据.参战单位[编号].指令.参数 == "观照万象"  then --观照万象
				--     local jnz={}
				--     for i=1,#战斗数据.参战单位[编号].主动技能 do
				--         local jnlx = skill:取技能类型(战斗数据.参战单位[编号].主动技能[i].名称)
				--         if #jnz < 14 and (jnlx == "增益技能" or jnlx == "物攻技能" or jnlx == "法攻技能" or jnlx == "固伤技能") and 战斗数据.参战单位[编号].主动技能[i].名称~="观照万象" then
				--             jnz[#jnz+1] = 战斗数据.参战单位[编号].主动技能[i].名称
				--         end
				--     end
				-- -- ========== 新增的4行==========
				--     local 增益技能 = {}
				--     -- 1. 把jnz里的增益技能摘出来，保存原顺序
				--     for i=#jnz,1,-1 do
				--         if skill:取技能类型(jnz[i]) == "增益技能" then
				--             table.insert(增益技能, 1, table.remove(jnz, i)) -- 摘出并保持原序
				--         end
				--     end
				-- -- ========== 新增结束 ==========
				--     -- 新增：Fisher-Yates洗牌算法打乱jnz表顺序（核心随机逻辑）
				--     for i = #jnz, 2, -1 do
				--         local j = 取随机数(1, i)
				--         jnz[i], jnz[j] = jnz[j], jnz[i]
				--     end
				-- -- ==========把增益技能放回最前面） ==========
				--     for _,v in ipairs(增益技能) do table.insert(jnz, 1, v) end
				-- -- ========== 新增结束 ==========
				--     -- 按打乱后的顺序释放技能（后续逻辑不变）
				--     for i=1,#jnz do
				...
				if 战斗数据.参战单位[编号].指令.参数 == "观照万象"  then --观照万象
				    local jnz={}
				    for i=1,#战斗数据.参战单位[编号].主动技能 do
				        local jnlx = skill:取技能类型(战斗数据.参战单位[编号].主动技能[i].名称)
				        if #jnz < 14 and (jnlx == "物攻技能" or jnlx == "法攻技能" or jnlx == "固伤技能") and 战斗数据.参战单位[编号].主动技能[i].名称~="观照万象" then
				            jnz[#jnz+1] = 战斗数据.参战单位[编号].主动技能[i].名称
				        end
				    end
				    -- 新增：Fisher-Yates洗牌算法打乱jnz表顺序（核心随机逻辑）
	                ...
	                -- elseif 战斗数据.参战单位[编号].指令.类型=="特技" then
	                --  if 战斗数据:取特技状态(战斗数据.执行对象[n]) then
	                --      战斗数据:法术计算(战斗数据.执行对象[n],1)
	                --      if 战斗数据.参战单位[编号].法术状态.愈勇 then
	                --          战斗数据:取消状态("愈勇",战斗数据.参战单位[编号])
	                --      end
	                --  end
	                ...
	                if 战斗数据.战斗流程[#战斗数据.战斗流程].攻击方 and 战斗数据.战斗流程[#战斗数据.战斗流程].攻击方 == 编号 then
	                    ...
	                    if 战斗数据.参战单位[编号].人参果 then
													战斗数据.战斗流程[#战斗数据.战斗流程].人参果更新 = {}
													for k,v in pairs(战斗数据.参战单位[编号].人参果) do
														战斗数据.战斗流程[#战斗数据.战斗流程].人参果更新[k] = v
													end
												end
												if 战斗数据.参战单位[编号].骤雨 then
													战斗数据.战斗流程[#战斗数据.战斗流程].骤雨更新 = {}
													for k,v in pairs(战斗数据.参战单位[编号].骤雨) do
														战斗数据.战斗流程[#战斗数据.战斗流程].骤雨更新[k] = v
													end
												end
	       ...
	       --  if 战斗数据.参战单位[战斗数据.执行对象[n]].超级敏捷.执行 then
                        if 战斗数据.参战单位[战斗数据.执行对象[n]].气血 > 0 and 战斗数据.参战单位[战斗数据.执行对象[n]].超级敏捷.执行 then
...
function 战斗执行类:奇袭指令执行(战斗数据,n,命令)
	if 战斗数据.全局结束==nil and 战斗数据:取行动状态(战斗数据.执行对象[n]) and not 战斗数据:死亡处理() then
			local 编号=战斗数据.执行对象[n]
			-- print(编号,"=========76876876",命令.目标,战斗数据.参战单位[编号].指令.目标)
			-- table.print(命令)
			if 命令 ~= nil then
				-- 战斗数据.参战单位[编号].指令 = 命令

			  if 命令.类型=="攻击" then--普通攻击
			  	local 目标1=命令.目标
					if 战斗数据:取攻击状态(编号) then
						if 命令.附加 == "友伤" then --这里可能需要增加 套装这些的触发，然后目标改为敌方单位
							if 战斗数据.参战单位[目标1]~=nil and 战斗数据.参战单位[目标1].队伍==战斗数据.参战单位[编号].队伍 and 战斗数据:取目标状态(编号,目标1,2) then
								战斗数据:普通攻击计算(编号,1,true)
							end
						else
							if 战斗数据.参战单位[命令.目标]~=nil and 战斗数据.参战单位[命令.目标].队伍==战斗数据.参战单位[编号].队伍 then
								命令.目标= 战斗数据:取单个敌方目标(编号)
								目标1=命令.目标
							end
							if 战斗数据.参战单位[编号].法术状态.神牛蹈火 then
								战斗技能:神牛蹈火(战斗数据,编号,目标1)
							else
								-- if not 战斗技能:高级连击(战斗数据,编号,目标1) and not 战斗技能:超级连击(战斗数据,编号,目标1) then --超级技能 增加
									战斗技能:普通攻击1(战斗数据,编号,目标1)
								-- end
							end
						end
				...
				elseif 命令.类型=="法术" and 装备特技[命令.参数]~=nil then
					-- print("===========释放特技：",战斗数据.参战单位[编号].指令.参数)
						if 战斗数据:取特技状态(战斗数据.执行对象[n]) and (战斗数据.参战单位[编号].队伍==0 or 初始技能计算:取技能CD(战斗数据,战斗数据.参战单位[编号],命令.参数)) then
							战斗数据:法术计算(编号,1)
							if 战斗数据.参战单位[编号].法术状态.愈勇 then
								战斗数据:取消状态("愈勇",战斗数据.参战单位[编号])
							end
						end
				elseif 命令.类型=="法术" then--法术攻击
					if 战斗数据:取法术状态(战斗数据.执行对象[n]) then
						if 战斗数据.参战单位[编号].队伍~=0 and not 初始技能计算:取技能CD(战斗数据,战斗数据.参战单位[编号],命令.参数) then
							return
						end
						战斗数据:法术计算(编号,1)
					end
				elseif 命令.类型=="道具" and 战斗数据.参战单位[编号].法术状态.煞气诀==nil  then
					if 战斗数据:取道具状态(战斗数据.执行对象[n]) then
						战斗数据:道具计算(战斗数据.执行对象[n],1,命令)
						if 战斗数据.参战单位[编号].玩家id ~= 0 then
							local pid = 战斗数据.参战单位[编号].玩家id
							发送数据(玩家数据[pid].连接id,3513,玩家数据[pid].道具:索要道具2(pid))
						end
					end
			  end
...
function 战斗执行类:复活后继续执行(战斗数据,编号) --羔羊复活后继续执行
      ...
      战斗技能:津津有味(战斗数据,战斗数据.参战单位[编号],编号)
			...
			if 战斗数据.参战单位[编号].指令 ~= nil and  战斗数据.参战单位[编号].指令.下达 then
				...
				elseif 战斗数据.参战单位[编号].指令.类型=="法术" then--法术攻击
					if 装备特技[战斗数据.参战单位[编号].指令.参数]~=nil then
						if 战斗数据:取特技状态(编号) and (战斗数据.参战单位[编号].队伍==0 or 初始技能计算:取技能CD(战斗数据,战斗数据.参战单位[编号],战斗数据.参战单位[编号].指令.参数)) then
							战斗数据:法术计算(编号,1)
							if 战斗数据.参战单位[编号].法术状态.愈勇 then
								战斗数据:取消状态("愈勇",战斗数据.参战单位[编号])
							end
    ...
    --           			if 战斗数据.参战单位[编号].指令.参数 == "观照万象" then --羔羊加观照万象
				-- 		local jnz={}
				-- 		for i=1,#战斗数据.参战单位[编号].主动技能 do
				-- 			local jnlx = skill:取技能类型(战斗数据.参战单位[编号].主动技能[i].名称)
				-- 			if #jnz < 4 and (jnlx == "物攻技能" or jnlx == "法攻技能" or jnlx == "固伤技能") and 战斗数据.参战单位[编号].主动技能[i].名称~="观照万象" then
				-- 				jnz[#jnz+1] = 战斗数据.参战单位[编号].主动技能[i].名称
				-- 			end
    --             					end
    --             					for i=1,#jnz do
...
function 战斗执行类:自动释放技能(战斗数据,单位,bh)-- 新增战斗数据参数
	...
	elseif 单位.指令.参数=="翻江搅海" and 单位.战意<3 then
		单位.指令.参数="浪涌"
	 elseif 单位.指令.参数 == "惊涛怒" and 单位.战意 < 1 then
                         单位.指令.参数 = "浪涌"

--==========魔王寨
	elseif 单位.指令.参数 == "飞砂走石" then
	      if 战斗数据.回合数 % 5 == 0 then
                     单位.指令.参数 = "风云变色"
                  end

--==========神木林
       --      elseif 单位.指令.参数 == "落叶萧萧" then
	      -- if 战斗数据.回合数 % 5 == 0 then
       --               单位.指令.参数 = "风卷残云"
       --            end
--====大唐
	elseif 单位.指令.参数 == "横扫千军" then
	    if 单位.气血 < 单位.最大气血 * 0.5 then
	       单位.指令.参数 = "普攻"
	    end
