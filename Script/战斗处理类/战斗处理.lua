...
function 战斗处理类:抓取自动数据(玩家id)
	...
	for n=1,#self.参战单位 do
		if self.参战单位[n].玩家id==玩家id then
			更改内容[#更改内容+1]={id=n,自动开关=self.参战单位[n].自动战斗,智能施法=self.参战单位[n].智能施法,自动指令=self.参战单位[n].自动指令}
		...
		for i=1,#self.参战单位[编号].助战表 do
			...
			for a=1,#self.参战单位 do
				if self.参战单位[a].玩家id == self.参战单位[x].玩家id then
					更改内容[#更改内容+1]={id=a,自动开关=self.参战单位[a].自动战斗,智能施法=self.参战单位[a].智能施法,自动指令=self.参战单位[a].自动指令}
				end
			end
		end
	end
