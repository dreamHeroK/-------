...
function AI战斗:智能战斗(战斗数据,编号,类型)
	...
	if 战斗数据.参战单位[编号].气血>0 then
		if 战斗数据:NPC_AI取友方被封印数量(编号) >= 4 and not 战斗数据.参战单位[编号].法术状态.催眠符 and not 战斗数据.参战单位[编号].法术状态.镇妖 and not 战斗数据.参战单位[编号].法术状态.日月乾坤 then    --被封印3个单位以上 会晶清
			战斗数据.参战单位[编号].指令.类型="法术"
			战斗数据.参战单位[编号].指令.参数= "晶清诀"
			战斗数据.参战单位[编号].指令.目标 =  天罡星AI:取防御最低目标(战斗数据,战斗数据.参战单位[编号].队伍,2,编号)
			return true
		end
...
function AI战斗:地煞战斗(战斗数据,编号,类型)
	if 战斗数据:NPC_AI取友方被封印数量(编号) > 3 and not 战斗数据.参战单位[编号].法术状态.催眠符 and not 战斗数据.参战单位[编号].法术状态.镇妖 and not 战斗数据.参战单位[编号].法术状态.日月乾坤 then    --被封印3个单位以上 会晶清
		战斗数据.参战单位[编号].指令.类型="法术"
		战斗数据.参战单位[编号].指令.参数= "晶清诀"
		战斗数据.参战单位[编号].指令.目标 =  天罡星AI:取防御最低目标(战斗数据,战斗数据.参战单位[编号].队伍,2,编号)
		return true
