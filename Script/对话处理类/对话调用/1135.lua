...
__NPCdh222[1135 ]=function  (id,数字id,序号,内容)
    ...
    elseif 名称=="觉岸" then
        ...
        elseif 事件=="购买五色旗盒" then
          添加最后对话(数字id,"你可以在我这里花费5000000两银子购买五色旗盒，请确认是否要购买五色旗盒？",{"确认购买","我没那么多的钱"})
        elseif 事件=="确认购买" then
          if 玩家数据[数字id].角色.银子<5000000 then
            添加最后对话(数字id,"你没有那么多的银子")
            return
          else
            if 玩家数据[数字id].角色:扣除银子(5000000,0,0,"觉案购买五色旗盒",1)== false then 常规提示(数字id,"你的银两不足") return end
