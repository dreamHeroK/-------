...
-- @Last Modified time: 2026-04-05 10:08:56
-- @作者: baidwwy
-- @邮箱:  313738139@qq.com
-- @创建时间:   2021-01-31 11:33:57
-- @最后修改来自: baidwwy
-- @Last Modified time: 2023-06-06 13:50:22
local sj = 取随机数
...
__NPCdh111[1216]=function (ID,编号,页数,已经在任务中,数字id)
	...
	elseif 编号 == 2 then
	 ...
	 elseif 编号 == 3 then
		...
		local xx = {"我想了解坐骑装饰以及摄灵珠","我想购买增加灵气物品","查询坐骑灵气","","","我想修炼坐骑装饰的“境界”","我悄悄的走，不带走一片云彩。"}--"我来看看有啥好看的",
...
__NPCdh222[1216 ]=function  (id,数字id,序号,内容)
	...
	elseif 名称=="百兽王" then
		if 事件=="我要领取坐骑任务" then
			添加最后对话(数字id,"坐骑可不是谁都能驾驭的，想要领取坐骑任务，需要消耗3000000银子，你还要领取坐骑任务吗？",{"开启坐骑任务","一毛不拔"})
		elseif 事件=="开启坐骑任务" then
			坐骑任务:开启坐骑任务(数字id)
		...
		elseif 事件=="我来取消坐骑任务" then
			玩家数据[数字id].角色:取消任务(玩家数据[数字id].角色:取任务(307))
			玩家数据[数字id].角色:刷新任务跟踪()
