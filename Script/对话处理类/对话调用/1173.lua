...
-- @Last Modified time: 2023-09-19 15:26:02
-- @作者: baidwwy
-- @邮箱:  313738139@qq.com
...
__NPCdh111[1173]=function (ID,编号,页数,已经在任务中,数字id)
    ...
    elseif 编号 == 38 then
		wb[1] = "吾乃风祖飞廉之幻影，奉命守卫九黎城，在此恭候各位侠士降临。"
	      	xx = {"请引领我至九黎城探寻奥秘。","我只是偶尔路过此地而已。"}
	    	return {"风祖飞廉","飞廉幻影",wb[取随机数(1,#wb)],xx}
	end
	return
end
...
__NPCdh222[1173 ]=function  (id,数字id,序号,内容)
	...
	elseif 名称 == '飞廉幻影' then
		if 事件 == '请引领我至九黎城探寻奥秘。' then
			地图处理类:跳转地图(数字id,1580,96,126)
		end
	elseif 名称=="轩辕" then
		local 门派神器名称 = {
