...
-- @Last Modified time: 2023-12-17 10:43:34
-- @作者: baidwwy
-- @邮箱:  313738139@qq.com
-- @创建时间:   2021-01-31 11:50:32
-- @最后修改来自: baidwwy
-- @Last Modified time: 2023-06-13 00:21:11
local sj = 取随机数
...
__NPCdh222[1854 ]=function  (id,数字id,序号,内容)
	...
	if 名称=="修炼指导人" then
		if 玩家数据[数字id].角色.BPBH == nil then
			添加最后对话(数字id,"少侠并没有帮派，无法操作")
			return
		end
		...
		elseif 事件=="人物修炼（免资材）" then
			...
			if 玩家数据[数字id].角色.MZC==nil then
		        玩家数据[数字id].角色.MZC={次数=150,时间=os.time()+86400}
		    else
