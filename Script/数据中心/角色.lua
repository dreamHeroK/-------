...
-- @Last Modified time: 2025-09-05 14:40:24
...
-- function 取法宝门派限制(名称,门派,id)
--     if (名称=="天师符" or 名称=="救命毫毛") and 门派~="方寸山" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="织女扇" or 名称=="曼陀罗") and 门派~="女儿村" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="雷兽" or 名称=="伏魔天书") and 门派~="天宫" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="定风珠" or 名称=="奇门五行令")  and 门派~="五庄观" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="忘情" or 名称=="迷魂灯") and 门派~="盘丝洞" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="七杀" or 名称=="干将莫邪") and 门派~="大唐官府" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="罗汉珠" or 名称=="慈悲") and 门派~="化生寺" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="金刚杵" or 名称=="普渡")  and 门派~="普陀山" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="兽王令" or 名称=="失心钹") and 门派~="狮驼岭" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="摄魂" or 名称=="九幽") and 门派~="阴曹地府" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
...
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="幽灵珠" or 名称=="金蟾" or 名称=="宝烛") and 门派~="无底洞" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="天煞" or 名称=="斩魔") and 门派~="凌波城" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif 名称=="月影" and 门派~="神木林" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return false
--     elseif (名称=="琉璃灯" or 名称=="金箍棒") and 门派~="花果山" then
--         常规提示(id,"#Y你的门派不允许你使用这样的法宝")
--         return
--     end
--     return true
