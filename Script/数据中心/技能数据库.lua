...
-- @Last Modified time: 2026-04-27 17:33:33
...
function 技能数据库:初始化()
	...
	枫影二刃 = {
		...
		龙战于野 = {
			...
			状态属性 = function(lv,sx,挨打方,攻击方,等级,境界,指定) --技能效果：降低自身法防并提高法伤，使用龙卷雨击、龙腾、亢龙归海时额外消耗350点魔法并提高16%(化圣1)/16%(化圣5)/20%(化圣9)伤害结果，持续8回合
			    return  {类型=1,状态回合=8,法防=qz(sx.法防*0.1)}
			end,
		},
		逆鳞 = {
			技能类型="增益技能",
		...
		威慑 = {
			...
			技能消耗 = function(mbs,攻击方)
			    if 攻击方 and 攻击方.法术状态 and 攻击方.法术状态.魔息术 and 攻击方.法术状态.魔息术.魔息~=nil then
					return  1 , "魔法"
				end
				return  20 , "魔法"
			end,
		...
		安神诀 = {
			...
			状态属性 = function(lv,sx,挨打方,攻击方,等级,境界,指定)
			    ...
			    return {状态回合=2,法防 = qz(lv*1.8),法伤 = qz(lv*1.8)}
			end,
		},
		其疾如风 = {
			技能类型="增益技能",
    ...
    --====================凌波城====================--
		...
		真君显灵 = {
			...
			状态属性 = function(lv,sx,挨打方,攻击方,等级,境界,指定)
			    挨打方.法术状态.真君显灵.加伤点 = (挨打方.战意+挨打方.超级战意)*20
				挨打方.战意=0
				挨打方.超级战意=0
			    return {状态回合=150}
			end,
    ...
    --====================特技====================--
		...
		虚弱 = {                               -------新增
			...
			状态属性 = function(lv,sx,挨打方,攻击方,等级,境界,指定)
				return {状态回合=2,伤害 = qz(sx.伤害 * 0.1),法伤=qz(sx.法伤*0.1)}
			end,
		},
		易伤 = {
			技能类型="减益技能",
			...
			状态属性 = function(lv,sx,挨打方,攻击方,等级,境界,指定)
				return {状态回合=3,法防=qz(sx.法防 * 0.3),防御=qz(sx.防御 * 0.3)}
			end,
		},
	...
	--====================召唤兽====================--
	    ...
	    地狱烈火 = {
			...
			技能人数 = function(lv,攻击方,PK)
			    ...
			    if sl>=3 then
			        sl = 3
			    if 攻击方.映雪棱镜 and 时辰信息.天气==3 then
			    	sl=sl+1
			    end
			    end
			    return sl
