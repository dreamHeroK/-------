...
-- @Last Modified time: 2025-08-31 15:07:35
--======================================================================--
-- @作者: GGE研究群: 342119466
-- @创建时间:   2018-03-03 02:34:19
-- @Last Modified time: 2023-05-18 12:35:20
...
变身卡范围={
	...
	-- ,[9]={"进阶猫灵人形","进阶夜罗刹","进阶混沌兽","进阶曼珠沙华"}
	,[9]={"进阶夜罗刹","进阶混沌兽","进阶毗舍童子","进阶长眉灵猴","进阶雾中仙","进阶猫灵人形"}
...
变身卡数据={
	...
	,进阶混沌兽={技能="高级魔之心",属性=0,类型="灵力",正负=0,等级=9}
	,进阶夜罗刹={技能="高级夜战",属性=5,类型="伤害",正负=1,等级=9}
	,进阶毗舍童子={技能="高级必杀",属性=0,类型="伤害",正负=0,等级=9}
	,进阶长眉灵猴={技能="法术暴击",属性=0,类型="气血",正负=0,等级=9}
	,进阶雾中仙={技能="高级敏捷",属性=5,类型="防御",正负=2,等级=9}
	,进阶猫灵人形={技能="高级幸运",属性=5,类型="法防",正负=1,等级=9}
