-- @Author: baidwwy
-- @Date:   2023-11-22 21:25:43
-- @Last Modified by:   baidwwy
-- @Last Modified time: 2026-03-31 08:28:32
--======================================================================--
-- @作者: GGE研究群: 342119466
...
Q_门派编号1={"大唐官府","化生寺","方寸山","女儿村","神木林","龙宫","五庄观","凌波城","普陀山","天宫","无底洞","阴曹地府","狮驼岭","魔王寨","盘丝洞","花果山","九黎城"}
...
function 取门派专属(门派)
	...
	elseif 门派 == "女儿村" then
		类型 = {"封印命中", "固定伤害"}
	elseif 门派 == "盘丝洞" or 门派 == "五庄观" then
		类型 = {"封印命中", "伤害"}
	elseif 门派 == "神木林" or 门派 == "魔王寨" or 门派 == "龙宫" then
		类型 = {"法术伤害"}
	elseif 门派 == "九黎城" or 门派 == "狮驼岭" or 门派 == "凌波城" or 门派 == "花果山" then--"大唐官府" or 门派 == "阴曹地府" or 门派 ==
		类型 = {"伤害"}
	elseif 门派 == "天宫" then
		类型 = {"伤害", "封印命中"}
	elseif 门派 == "大唐官府" then
...
function 取随机法术(数量)
	local 法术={"荆棘舞","水攻","雷击","烈火","落岩","奔雷咒","泰山压顶","推气过宫","金刚护体","落叶萧萧","裂石","地涌金莲","推拿","夺魄令","地涌金莲","催眠符","失心符","含情脉脉","似玉生香","横扫千军","唧唧歪歪","金刚护法","五雷咒","龙卷雨击","浪涌","龙吟","龙腾","天雷斩","烟雨剑法","五雷轰顶","飞砂走石","三昧真火","狮搏","鹰击","连环击","反间之计"}
	local 返回组={}
	for n=1,数量 do
		返回组[n]=法术[取随机数(1,#法术)]
	end
