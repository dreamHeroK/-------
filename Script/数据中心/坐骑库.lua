...
-- @Last Modified time: 2024-01-11 14:02:23
--======================================================================--
...
function 坐骑资料库:取坐骑库(人物) --这里才对
	...
	elseif 人物.种族 == "魔" and 人物.模型 ~= "鬼潇潇" and 人物.模型 ~= "骨精灵" then
		local zqsQ = random(1,2)
		if zqsQ==1 then
		    zqsQQ = "魔力斗兽"
		else
	...
	elseif 人物.种族 == "仙" and 人物.模型 ~= "桃夭夭" and 人物.模型 ~= "龙太子" then
		local zqsQ = random(1,2)
		if zqsQ==1 then
		   zqsQQ = "闲云野鹤"
		else
