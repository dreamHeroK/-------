-- @Author: baidwwy
-- @Date:   2023-09-23 09:04:59
-- @Last Modified by:   baidwwy
-- @Last Modified time: 2025-12-04 14:32:53
--======================================================================--
-- @作者: GGE研究群: 342119466
-- @创建时间:   2018-03-03 02:34:19
-- @Last Modified time: 2022-12-03 11:19:56
...
function 内存类_物品:置对象(名称,打造,总类,级别)
	...
	elseif self.总类 == 5 then --宝石
		...
		elseif self.分类 == 6 then
			...
			if self.名称 == "附魔宝珠" or self.名称 == "钨金" or self.名称 == "陨铁" then
				self.可叠加 = true
			end
	...
	elseif self.总类 == 100 then
		self.可叠加 = true
	elseif self.总类 == 101 and self.子类 > 1 then
		self.可叠加 = true
	...
	elseif self.总类 == 181 or self.总类 == 182 then
		self.可叠加 = true
	end
	...
	if self.名称 == "神兽涎" or self.名称 == "仙露小丸子" then
		self.可叠加 = true
	end
	if self.总类 == "上古玉魄" or self.名称 == "五色灵尘" then
		self.可叠加 = false
	end
	self.介绍=nil
	self.大模型资源=nil
