...
function 角色处理类:添加经验(数额, 类型, 提示)
    ...
    if 类型 == "野外" or 类型 == "捉鬼" or 类型 == "抓鬼10次" or 类型 == "抓鬼变异" or 类型 == "自动抓鬼10次" or 类型 == "鬼王" or 类型 == "官职" or 类型 == "封妖战斗" or 类型 == "种族" or 类型 == 100008 or 类型 == 101000 or 类型 == 100004 or 类型 == 110077 then--or 类型 == "门派闯关" then
...
function 角色处理类:添加银子(数额, 说明, 提示)
    ...
    -- if 分角色累充定制 then VIP加成 = 取VIP等级加成(取累充金额1(self.数字id)) end
    if 说明 == "捉鬼" or 说明 == "封妖战斗" or 说明 == "抓鬼10次" or 说明 == "抓鬼变异" or 说明 == "自动抓鬼10次" or 说明 == "鬼王"
        or 说明 == 100008 or 说明 == 101000 or 说明 == 100004 or 说明 == 110077 then
        if self:取任务(2) ~= 0 then --双倍
            倍率=倍率+1
        end
        if self:取任务(3) ~= 0 then --三倍
