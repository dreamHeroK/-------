...
-- @最后修改来自: baidwwy
-- @Last Modified time: 2026-05-18 11:12:58
function 设置任务2(时间,类型,id) --1为领取 2为解冻
	if 双倍数据[id]==nil then
		双倍数据[id]={可领=15,冻结=0,间隔=os.time()}
	end
...
function 任务说明2(玩家id,任务id)
	local 说明 = {}
	说明={"双倍时间","#L你的双倍时间还可持续#R/"..取分((任务数据[任务id].结束-(os.time()-任务数据[任务id].起始))).."#L/分钟。","野外战斗、抓鬼、封妖、官职、种族、门派闯关活动任务中所获得的经验、银子、储备翻倍。本效果可以与精修时间叠加。"}
	return 说明
end