-- @Author: baidwwy
-- @Date:   2023-11-02 02:30:07
-- @Last Modified by:   baidwwy
-- @Last Modified time: 2023-11-02 11:20:44
-- @作者: baidwwy
-- @邮箱:  313738139@qq.com
...
function 设置任务2031()
	...
	广播消息({内容=format("#W/青铜矿石已刷新在#G/%s、%s、%s、%s、#W/，少侠们快去挖矿，完了就被挖光了#G(要求熟练度:0)。".."#"..取随机数(1,110),刷新地图[1],刷新地图[2],刷新地图[3],刷新地图[4]),频道="xt"})
end

function 设置任务2032()
	local 地图范围={1174,1131,1228,1042}
	local 地图=地图范围[取随机数(1,#地图范围)]
    local 数量=取随机数(1,10)
	local 刷新地图={}
	for i=1,#地图范围 do
	...
	广播消息({内容=format("#W/白银矿石已刷新在#G/%s、%s、%s、%s、#W/，少侠们快去挖矿，完了就被挖光了#G(要求熟练度:25)。".."#"..取随机数(1,110),刷新地图[1],刷新地图[2],刷新地图[3],刷新地图[4]),频道="xt"})
end
function 设置任务2033()
	local 地图范围={1202,1201,1210,1041}
	local 地图=地图范围[取随机数(1,#地图范围)]
    local 数量=取随机数(1,10)
	local 刷新地图={}
	for i=1,#地图范围 do
	...
	广播消息({内容=format("#W/翡翠矿石已刷新在#G/%s、%s、%s、%s、#W/，少侠们快去挖矿，完了就被挖光了#G(要求熟练度:100)。".."#"..取随机数(1,110),刷新地图[1],刷新地图[2],刷新地图[3],刷新地图[4]),频道="xt"})
end
function 设置任务2034()
	local 地图范围={1211,1242,1232,1229}
	local 地图=地图范围[取随机数(1,#地图范围)]
    local 数量=取随机数(1,10)
	local 刷新地图={}
	for i=1,#地图范围 do
	...
	广播消息({内容=format("#W/黄金矿石已刷新在#G/%s、%s、%s、%s、#W/，少侠们快去挖矿，完了就被挖光了#G(要求熟练度:300)。".."#"..取随机数(1,110),刷新地图[1],刷新地图[2],刷新地图[3],刷新地图[4]),频道="xt"})
end
function 设置任务2035()
	local 地图范围={1231,1203,1204,1920}
	local 地图=地图范围[取随机数(1,#地图范围)]
    local 数量=取随机数(1,10)
	local 刷新地图={}
	for i=1,#地图范围 do
	...
	广播消息({内容=format("#W/紫金矿石已刷新在#G/%s、%s、%s、%s、#W/，少侠们快去挖矿，完了就被挖光了#G(要求熟练度:500)。".."#"..取随机数(1,110),刷新地图[1],刷新地图[2],刷新地图[3],刷新地图[4]),频道="xt"})
end
