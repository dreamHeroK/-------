...
function 二八星宿:刷新资源()
	local dtmc=""
    local 地图范围={1140,1207,1142,1092,1514,1506,1116,1226,1040,1042,1091,1041,1208,1210,1135,1111,1273,1177,1178,1186,1187,1174,1201,1193,1131,1001,1198,1002,1173,1512,1110,1218,1146}
    for i=1,7 do
	...
	广播消息({内容=format("#P(二八星宿)#W传说中的二十八星宿来到凡间寻找有缘人，大家赶快前往#Y%s#W迎接他们吧！#81",dtmc),频道="xt"})
end
